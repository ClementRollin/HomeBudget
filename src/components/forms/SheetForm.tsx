...
const SheetForm = ({ sheetId, initialValues }: SheetFormProps) => {
  ...
  return (
    ...
    >
      <section className="grid gap-6 md:grid-cols-2">
        <div>
          <label className="text-sm text-slate-400">Anne</label>
          <input
            type="number"
            min={2000}
            max={2100}
      ...
      <DynamicFieldSection
        ...
        onAdd={() => appendSalary({ person: PEOPLE[0], label: "", amount: 0 })}
      >
      ...
      <DynamicFieldSection
        title="Charges"
        description="Dclarez toutes les dpenses prvues"
      ...
      <DynamicFieldSection
        title="Budgets"
        description="Rpartissez les enveloppes mensuelles"
